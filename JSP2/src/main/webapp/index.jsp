...
<body>
	...
	<pre>
HTML : html, css, js 코드 작성 가능 => 정적인 페이지 (미리 만들어 둔 형태 그대로)

JSP : html, css, js, java, el, jstl 작성 가능 => 동적인 페이지 (요청에 따라 응답화면 변함)	
	</pre>
	
	<hr>
	
	<%-- form 태그에 method 속성 생략 시 기본값 GET --%>
	...
	<pre>
- 클라이언트 요청을 받은 Servlet/JSP가 직접 응답하는것이 아닌
