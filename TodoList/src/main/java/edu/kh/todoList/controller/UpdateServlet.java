...
public class UpdateServlet extends HttpServlet{
	...
	// 수정 버튼 클릭 시 요청한 수정 화면으로의 전환 GET 요청
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			// 수정 화면에는 기존의 제목, 상세내용이 input, textarea에 채워져 있어야 함!
	...
	/* 요청 주소가 같을 때 데이터 제출 방식이 다르면 (GET/POST)
	 * 하나의 Servlet class에서 각각의 메서드를 만들어 처리 가능! 
	 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			// 전달받은 parameter 얻어오기 (제목, 상세 내용, todoNo)
